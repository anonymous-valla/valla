...
class SPGP_Dataset(VaLLADataset):
    def __init__(self):
...
class Synthetic_Dataset(VaLLADataset):
    def __init__(self):
        self.type = "regression"
        self.output_dim = 1
...
class Synthetic2_Dataset(VaLLADataset):
    def __init__(self):
        self.type = "regression"
        self.output_dim = 1
...
class MNIST_Dataset(VaLLADataset):
    def __init__(self):
...
class FMNIST_Dataset(VaLLADataset):
    def __init__(self):
        self.type = "multiclass"
        self.classes = 10
        self.output_dim = 10
...
class CIFAR10_Dataset(VaLLADataset):
    def __init__(self):
        self.type = "multiclass"
        self.classes = 10
        self.output_dim = 10
...
class Banana_Dataset(VaLLADataset):
    def __init__(self):
        self.type = "multiclass"
        self.classes = 2
        self.output_dim = 1
...
class Airline_Dataset(VaLLADataset):
    def __init__(self):
        self.type = "regression"
        self.output_dim = 1
...
class Year_Dataset(VaLLADataset):
    def __init__(self):
        self.type = "regression"
        self.output_dim = 1
        try:
...
class Taxi_Dataset(VaLLADataset):
    def __init__(self):
        self.type = "regression"
        self.output_dim = 1
